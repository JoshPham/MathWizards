...
import CoordinatePlaneComponent from './pages/authentication/CoordinatePlane';
      ...
      <AuthProvider>
        ...
        <div>
          <Routes>
            ...
            <Route path='/coordinate-plane' element={<PrivateRoute component={CoordinatePlaneComponent} redirectTo="/login" />} />
            ...
            <Route path='/ten-frame' element={<PrivateRoute component={TenFrame} redirectTo="/login" />} />
